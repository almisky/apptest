...
<li class="breadcrumb-item active" aria-current="page"><span>Add Products</span></li>
                        ...
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll"
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 layout-spacing">
                                    <form id="general-info" action="{{ route('actionaddproducts') }}" method="POST" class="section general-info">
                                        @csrf
                                        <input type="hidden" class="form-control mb-4" id="id_username" name="username" value="<?= session('user_id') ?>">
                                        <div class="info">
                                            <h6 class="">Add Products</h6>
                                            <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"
                                                                                id="id_name" name="name" placeholder="products name">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" id="id_cc" name="cc" placeholder="cubicle centimeter">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
